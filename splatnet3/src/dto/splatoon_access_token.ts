...
export class SplatoonAccessTokenNoResources {
...
export class SplatoonAccessTokenInvalidToken {
...
export class SplatoonAccessTokenUnauthorized {
...
export class SplatoonAccessTokenUpgradeRequired {
...
export class SplatoonAccessTokenRequest {
  @ApiProperty({
    example: '2.3.1',
  })
  @Expose()
...
export class SplatoonAccessTokenResponse {
